...
//   Generating script: generate_valid_moves.py
// -----------------------------------------------------------------------------
//
#include "board.h"
#include <array>
...
inline static void _collect_0(std::vector<Move> &l3_moves,
                              std::vector<Move> &l2_moves,
                              std::vector<Move> &l1_moves, const Slice &top,
                              const Slice &bace) {
  // ---------- loc == 0 ----------
...
inline static void _collect_1(std::vector<Move> &l3_moves,
                              std::vector<Move> &l2_moves,
                              std::vector<Move> &l1_moves, const Slice &top,
                              const Slice &bace) {
  // ---------- loc == 1 ----------
...
inline static void _collect_2(std::vector<Move> &l3_moves,
                              std::vector<Move> &l2_moves,
                              std::vector<Move> &l1_moves, const Slice &top,
                              const Slice &bace) {
  // ---------- loc == 2 ----------
...
inline static void _collect_3(std::vector<Move> &l3_moves,
                              std::vector<Move> &l2_moves,
                              std::vector<Move> &l1_moves, const Slice &top,
                              const Slice &bace) {
  // ---------- loc == 3 ----------
...
inline static void _collect_4(std::vector<Move> &l3_moves,
                              std::vector<Move> &l2_moves,
                              std::vector<Move> &l1_moves, const Slice &top,
                              const Slice &bace) {
  // ---------- loc == 4 ----------
...
inline static void _collect_5(std::vector<Move> &l3_moves,
                              std::vector<Move> &l2_moves,
                              std::vector<Move> &l1_moves, const Slice &top,
                              const Slice &bace) {
  // ---------- loc == 5 ----------
...
inline static void _collect_6(std::vector<Move> &l3_moves,
                              std::vector<Move> &l2_moves,
                              std::vector<Move> &l1_moves, const Slice &top,
                              const Slice &bace) {
  // ---------- loc == 6 ----------
...
inline static void _collect_7(std::vector<Move> &l3_moves,
                              std::vector<Move> &l2_moves,
                              std::vector<Move> &l1_moves, const Slice &top,
                              const Slice &bace) {
  // ---------- loc == 7 ----------
...
inline static void _collect_8(std::vector<Move> &l3_moves,
                              std::vector<Move> &l2_moves,
                              std::vector<Move> &l1_moves, const Slice &top,
                              const Slice &bace) {
  // ---------- loc == 8 ----------
...
inline static void _collect_9(std::vector<Move> &l3_moves,
                              std::vector<Move> &l2_moves,
                              std::vector<Move> &l1_moves, const Slice &top,
                              const Slice &bace) {
  // ---------- loc == 9 ----------
...
inline static void _collect_10(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 10 ----------
...
inline static void _collect_11(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 11 ----------
...
inline static void _collect_12(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 12 ----------
...
inline static void _collect_13(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 13 ----------
...
inline static void _collect_14(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 14 ----------
...
inline static void _collect_15(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 15 ----------
...
inline static void _collect_16(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 16 ----------
...
inline static void _collect_17(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 17 ----------
...
inline static void _collect_18(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 18 ----------
...
inline static void _collect_19(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 19 ----------
...
inline static void _collect_20(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 20 ----------
...
inline static void _collect_21(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 21 ----------
...
inline static void _collect_22(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 22 ----------
...
inline static void _collect_23(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 23 ----------
...
inline static void _collect_24(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 24 ----------
...
inline static void _collect_25(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 25 ----------
...
inline static void _collect_26(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 26 ----------
...
inline static void _collect_27(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 27 ----------
...
inline static void _collect_28(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 28 ----------
...
inline static void _collect_29(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 29 ----------
...
inline static void _collect_30(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 30 ----------
...
inline static void _collect_31(std::vector<Move> &l3_moves,
                               std::vector<Move> &l2_moves,
                               std::vector<Move> &l1_moves, const Slice &top,
                               const Slice &bace) {
  // ---------- loc == 31 ----------
...
_valid_capturing_moves_from_top_down(const Slice &top, const Slice &bottom,
                                     const Loc &ix) {
